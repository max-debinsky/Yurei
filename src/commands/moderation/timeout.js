...
module.exports = {
    ...
    callback: async (client, interaction) => {
        ...
        if(msDuration < 5000 || msDuration > 2.419e9) {
            await interaction.editReply("Timeout duration cannot be less than 5s or more than 28 days.");
            return;
        }
        ...
        try {
            ...
            console.log(`There was an error with timeing out. Error: ${error}`);
        }
    },
    ...
    options: [
        ...
        {
            name: 'reason',
            description: 'The reason for timeing out the user.',
            type: ApplicationCommandOptionType.String,
        },
    ],
